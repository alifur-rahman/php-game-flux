...
<head>
    ...
    <link href="css/unitip.css" rel="stylesheet" type="text/css" media="screen" title="" charset="utf-8" />
...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <?php require_once('header-navs.php'); ?>
            <!-- .navbar -->
            <!-- End LowProfileMode -->
        </div>
    </header>
    ...
    <section id="hero" class="d-flex align-items-center">
        ...
        <div class="container">
            ...
            <!-- hero user area  -->
            <!-- <?php require_once('header-user-area.php'); ?> -->
